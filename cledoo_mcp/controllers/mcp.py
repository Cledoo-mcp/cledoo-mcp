...
Gated by the `cledoo_mcp.enabled` system parameter (Settings toggle,
...
from odoo.addons.cledoo_mcp.lib.jsonrpc import make_error, make_result, parse_request
...
def _load_module_version():
    ...
    try:
        ...
        manifest = get_manifest("cledoo_mcp")
    except ImportError:
        from odoo.modules.module import load_manifest
        manifest = load_manifest("cledoo_mcp")
...
class McpController(http.Controller):
    ...
    def mcp(self, **kw):
        from odoo.addons.cledoo_mcp.lib.params import is_enabled
        ...
        from odoo.addons.cledoo_mcp.lib.auth import resolve_bearer_details
        from odoo.addons.cledoo_mcp.lib.params import get_int_param
        from odoo.addons.cledoo_mcp.lib.ratelimit import check as rl_check
        ...
        limit = get_int_param(
            request.env, "cledoo_mcp.rate_limit", RATE_LIMIT_DEFAULT)
    ...
    def _dispatch(self, req, details):
        uid = details["uid"]
        from odoo.addons.cledoo_mcp.lib.tools import ToolError, normalize_tool_args
        from odoo.addons.cledoo_mcp.models.gateway import UnknownToolError
    ...
    def mcp_health(self, **kw):
        ...
        from odoo.addons.cledoo_mcp.lib.auth import resolve_bearer_details
        from odoo.addons.cledoo_mcp.lib.params import get_int_param, is_enabled
        ...
        if details:
            ...
            body.update({
                ...
                "rate_limit_per_minute": get_int_param(
                    request.env, "cledoo_mcp.rate_limit",
                    RATE_LIMIT_DEFAULT),
