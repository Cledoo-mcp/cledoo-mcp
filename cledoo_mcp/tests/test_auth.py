...
`cledoo_mcp.enabled` 404 gate (checked before auth), header parsing,
...
class TestMcpHttpAuth(HttpCase):
    ...
    def test_valid_key_tools_list_matches_registry(self):
        from odoo.addons.cledoo_mcp.lib.tools import TOOLS
    ...
    def test_valid_key_initialize_reports_manifest_version(self):
        ...
        manifest_version = get_manifest("cledoo_mcp")["version"]
