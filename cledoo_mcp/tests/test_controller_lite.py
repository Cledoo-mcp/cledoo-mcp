...
class TestActivePathPurity(TransactionCase):
    def test_controller_module_does_not_import_vendor(self):
        import odoo.addons.cledoo_mcp.controllers.mcp as ctrl  # noqa: F401
        import odoo.addons.cledoo_mcp.lib.tools  # noqa: F401
        import odoo.addons.cledoo_mcp.lib.auth  # noqa: F401
        import odoo.addons.cledoo_mcp.models.gateway  # noqa: F401
        src = open(ctrl.__file__).read()
        self.assertNotIn("vendor", src)
        for mod in ("lib.tools", "lib.auth", "models.gateway"):
            f = sys.modules["odoo.addons.cledoo_mcp." + mod].__file__
