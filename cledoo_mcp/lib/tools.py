...
from odoo.addons.cledoo_mcp.lib.sanitize import sanitize_error_message
...
# all gate on one admin-configurable ceiling: the cledoo_mcp.max_inline_mb
...
def _max_inline_bytes(env):
    ...
    mb = get_int_param(env, "cledoo_mcp.max_inline_mb", DEFAULT_MAX_INLINE_MB)
