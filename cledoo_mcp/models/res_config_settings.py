...
class ResConfigSettings(models.TransientModel):
    ...
    mcp_max_inline_mb = fields.Integer(
        ...
        config_parameter="cledoo_mcp.max_inline_mb",
    ...
    mcp_annotate_messages = fields.Boolean(
        ...
        config_parameter="cledoo_mcp.annotate_messages",
    ...
    mcp_telemetry = fields.Boolean(
        ...
        config_parameter="cledoo_mcp.telemetry",
    ...
    def _compute_mcp_module_version(self):
        ...
        try:
            ...
            version = get_manifest("cledoo_mcp").get("version", "?")
        except ImportError:
            from odoo.modules.module import load_manifest
            version = load_manifest("cledoo_mcp").get("version", "?")
        for rec in self:
