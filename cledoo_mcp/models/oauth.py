...
from odoo.addons.cledoo_mcp.lib import oauth_tokens as T
...
# reconnect prompt). Admin-tunable via cledoo_mcp.oauth_access_ttl_hours.
...
def access_ttl(env):
    ...
    hours = get_int_param(env, "cledoo_mcp.oauth_access_ttl_hours",
